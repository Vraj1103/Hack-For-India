      ...
      <div className="flex">
        <div className="w-[50%] ml-10">
          ...
          <div className="bottom">
            <p className="mt-3 text-xl">Cruiser Avilability :-</p>
          ...
          <div className="w-[45%] border-2 border-black h-[calc(100vh-192px)]">
            {/* Display the Google Maps URL or integrate Google Maps here */}
            <img src="https://th.bing.com/th/id/OIP.-9dtLrMmiT1Sm7r-zJwUcAHaEK?pid=ImgDet&rs=1" alt="Map" border="0" className="w-[full] h-full"/>
